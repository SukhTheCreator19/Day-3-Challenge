...
first = str(input("Enter First Letter: ")).lower() #Asks the user for a letter to search in text
print("First Letter:", first) #Prints the letter provided
second = str(input("Enter Second Letter: ")).lower() #Asks the user for a letter to search in text
print("First Letter:", second) #Prints the letter provided
third = str(input("Enter Third Letter: ")).lower()#Asks the user for a letter to search in text
...
first_letter = text[0]
last_letter = text[-1]
print("The first letter of the text is {} and the last letter is {}".format(first_letter, last_letter))
